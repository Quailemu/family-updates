...
# Voice-message.com legal documents register

Status: working register (update when documents are added, revised, signed, or replaced)
...
- Keep previous versions with date suffixes.
- Record who approved each change.
- Do not delete signed historical records; supersede with status notes.
