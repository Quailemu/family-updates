...
In this example, the page is for the family member, Kate S.

And the care home is High Elms Care Home.

The How it works button and the menu icon provide information.

---

First, we come to the latest message from the resident.
...
The message asks whether Kate S would like to arrange the appointment and transport, or whether the care home should arrange this.
