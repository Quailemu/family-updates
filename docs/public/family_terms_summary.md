...
This is a short, plain-English summary of the Family app terms. It does not replace the care home’s own policies.
...
- Only the latest message and latest reply are kept; there is no message history.
