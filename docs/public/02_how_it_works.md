...
2. Each approved family member or friend has their own voice-message channel with a resident.
...
3. Select an approved family member or friend and play their latest message to the resident.
...
3. Confirm that the system is operating correctly:  
   - one message per approved family member or friend -> resident  
   - one message per resident -> approved family member or friend
