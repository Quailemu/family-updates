...
A: The service keeps one current message each way. New messages replace previous ones.
...
A: Messages are used in a care-home setting and are not guaranteed to be private.
