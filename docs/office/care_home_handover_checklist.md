...
- [ ] Support contact details are agreed (care home + platform).
- [ ] Staff know how to report suspected misuse or errors.
- [ ] Care home understands the platform does not monitor content.

## Sign-off

- [ ] Scope statement reviewed and agreed (internal).
